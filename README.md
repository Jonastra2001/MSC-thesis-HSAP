...
| Variant         | Test perplexity | ECL (95% criterion) | ECE   |
|-----------------|-----------------|---------------------|-------|
| Baseline        | 32.89           | 256                 | 0.045 |
| Prune-only      | 35.16           | 64                  | 0.051 |
| Prune + spawn   | 34.93           | 128                 | 0.009 |
| HSAP (full)     | 33.00           | 64                  | 0.015 |
...
```bash
# Train the four variants (each runs for 6 hours wall-clock on a single RTX 5070)
...
```bibtex
@mastersthesis{otterspeer2026hsap,
...
Jonathan Otterspeer · [@Jonastra2001](https://github.com/Jonastra2001)
